...
\subsection{Immediate Operand}
Notes:
\begin{itemize}
    % Notes
    \item Rsrc1\_selector is the same as Rdst1\_selector, in SHL and SHR cases, but in IADD case its a different register, and at LDM case there's no need for Rsrc it's just a destination.
...
\begin{tabular}{||p{20mm}| p{15mm}| p{15mm}| p{15mm}| p{10mm}| p{15mm}| p{15mm}| p{15mm}||} 
\hline
Instruction & OPCode & ALUop & Rsrc1 selector & Rsrc2 selector & Rdst1 selector & Rsrc2 val & OP2 selector  \\ [0.5ex] 
\hline\hline
...
\begin{itemize}
    ...
    \item OP2\_selector is 1 to pass the EA.
    \item R/W memory (11) is write and (10) is read.
\end{itemize}

\begin{center}
    \captionof{table}{Memory Instruction Control Signals Part I\label{tab:memop1}}
\begin{tabular}{||p{20mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}||} 
\hline
Instruction & OPCode & ALUop & Rsrc1 selector & Rsrc2 selector & Rdst1 selector & Rsrc2 val & OP2 selector  \\ [0.5ex] 
\hline\hline
...
\begin{center}
    \captionof{table}{Memory Instruction Control Signals Part II\label{tab:memop2}}
\begin{tabular}{||p{20mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}||} 
\hline
Instruction & Rdst2 (swap) & Branch /IO Enable & SP Enable & Branch Enable & R/W Control Signal  \\ [0.5ex] 
\hline\hline
...
\begin{itemize}
    ...
    \item AluOp Inc2 and Dec2..., are used to manipulate the Stack Pointer, thus the output of the Alu will be the new Stack Pointer.
    \item In case of Call, Rsrc1\_selector is none, as no Register is used, it is the PC that is gonna be pushed at the memory.
    \item In case of Call, Rdst1\_selector, is the register holding the new address.
    \item In case of Ret and Rti, no registers are affected, as the PC is updated at the fetch stage.
    \item R/W memory (11) is write and (10) is read.
\end{itemize}

\begin{center}
    \captionof{table}{Stacks Instruction Control Signals Part I\label{tab:stackop1}}
\begin{tabular}{||p{20mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}||} 
\hline
Instruction & OPCode & ALUop & Rsrc1 selector & Rsrc2 selector & Rdst1 selector & Rsrc2 val & OP2 selector  \\ [0.5ex] 
\hline\hline
...
\begin{tabular}{||p{20mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}||} 
\hline
Instruction & Rdst2 (swap) & Branch /IO Enable & SP Enable & Branch Enable (JZ) & R/W Control Signal \\ [0.5ex] 
\hline\hline
PUSH & 1111 & 00 & 1 & 0 & 11 \\
\hline
POP & 1111 & 00 & 0 & 0 & 10 \\
...
\begin{itemize}
    % Notes
    \item Rsrc1\_selector is the address we are jumping to, that's why we need to verify that our prediction at the JZ case is correct.
...
\begin{tabular}{||p{20mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}| p{15mm}||} 
\hline
Instruction & Rdst2 (swap) & Branch /IO Enable & SP Enable & Branch Enable (JZ) & R/W Control Signals  \\ [0.5ex] 
\hline\hline
NOP & 1111 & 00 & 0 & 0 & 00 \\
\hline
